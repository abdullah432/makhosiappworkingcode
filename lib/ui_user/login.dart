...
import 'package:makhosi_app/ui_user/forgot.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  static const color = const Color(0xff78bebd);
  ...
  Widget _getFormUI() {
    return new Column(
      children: <Widget>[
        ...
        Text('Please provide us with your contact details so that we can keep you up to date with all news and interesting new offers from Mkhosi'),
        new SizedBox(height: 20.0),
        new TextFormField(
        ...
        new FlatButton(
          ...
          child: Text('Skip for now', style: TextStyle(color:color)),
        ),
      ],
    );
  }
